...
from python.mortgageRate.model.metamorphic_relation import  MetamorphicRelationFactory
...
from python.mortgageRate.generation.phase1.partition_generator import PartitionGenerator
...
class MGDomainGenerator:
    ...
    def __init__(self, domain_size: int = 1000):
        ...
        self.config_extractor = MortgageConfigExtractor(self.config_path)
