...
class TestCaseGenerationEffectivenessExperimentMT:
    ...
    def __init__(
        ...
        if thread_pool_size is None:
            ...
            cpu_count = min(mutant_count, 8)  # Limit maximum thread count
    ...
    def setup_logger(self):
        ...
        try:
            ...
            log_file = log_dir / f"experiment_multithreaded_{timestamp}.log"
    ...
    def execute_metamorphic_test(self, mutant_func, mg: MetamorphicGroup) -> bool:
        ...
        try:
            ...
            source_result = mutant_func(mg.get_source_test().get_house_value())
            followup_result = mutant_func(mg.get_followup_test().get_house_value())
    ...
    def save_experiment_config(self, strategy: str):
        ...
        config_file = (
            self.results_dir / f"experiment_config_{strategy}_multithreaded.json"
        )
