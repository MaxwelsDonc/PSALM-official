"""
This module defines the abstract base class for metamorphic relations and a factory class
for creating and managing metamorphic relations. Metamorphic relations are used to generate
and verify test cases based on source-followup relationships.
"""
...
class MetamorphicRelation(ABC):
    ...
    def generate_followup_tests(self, source_test: TestCase) -> List[TestCase]:
        ...
        """
        raise NotImplementedError("Subclasses must implement generate_followup_tests()")
    ...
    def is_applicable_to(self, test_case: TestCase) -> bool:
        ...
        """
        raise NotImplementedError("Subclasses must implement is_applicable_to()")
    ...
    def create_groups(self, source_test: TestCase) -> List[MetamorphicGroup]:
        ...
        for followup_test in followup_tests:
            group = MetamorphicGroup(
                self.get_id(), self.get_description(), source_test, followup_test
            )
            groups.append(group)
