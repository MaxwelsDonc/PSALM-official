import json
import python.geometricSum.utils.get_path_utils


class GeometricSumConfigExtractor:
...
if __name__ == "__main__":
    config_path = python.geometricSum.utils.get_path_utils.get_config_path()
    extractor = GeometricSumConfigExtractor(config_path)
