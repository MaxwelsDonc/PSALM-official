...
from python.geometricSum.generation.phase1.random_generator import RandomGenerator
from python.geometricSum.model.test_case import TestCase
from python.geometricSum.mutants.mutants import mutants
from python.geometricSum.mutants.origin import geometric_sum
        ...
        for mutant_name in self.mutant_names:
            ...
            try:
                ...
                for test_case in self.test_cases:
                    input_str = str(test_case.get_x_value())
