package paper.pss.exp.math1_project.utils;

import java.util.ArrayList;
import java.util.List;

import paper.pss.exp.math1_project.model.MetamorphicRelation;
import paper.pss.exp.math1_project.metamorphicRelations.MR1_relation;
import paper.pss.exp.math1_project.metamorphicRelations.MR2_relation;
import paper.pss.exp.math1_project.metamorphicRelations.MR3_relation;
import paper.pss.exp.math1_project.metamorphicRelations.MR4_relation;
import paper.pss.exp.math1_project.metamorphicRelations.MR5_relation;
...
public class MRFactory_utils {
    ...
    static {
        ...
        ALL_RELATIONS.add(new MR1_relation()); // Commutative Relation
        ALL_RELATIONS.add(new MR2_relation()); // Associative Relation
        ALL_RELATIONS.add(new MR3_relation()); // Distributive Relation
        ALL_RELATIONS.add(new MR4_relation()); // Linear Scaling Relation
        ALL_RELATIONS.add(new MR5_relation()); // Shift Relation
    }
    ...
    /**
     * Get the total number of available metamorphic relations
     * @return The count of metamorphic relations
     */
     ...
     * @return List of all relation IDs
     */
